 ...
 * @author kelly
 */
@WebServlet(name="PSVitaServlet", urlPatterns={"/PSVitaServlet"})
public class PSVitaServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String XMLFileName = path + "/Playstation.xml";
            String XSLFileName = path + "/psvita.xsl";
