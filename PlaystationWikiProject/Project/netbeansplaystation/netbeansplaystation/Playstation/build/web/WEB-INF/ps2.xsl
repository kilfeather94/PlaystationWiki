    ...
    <xsl:template match="/">
        <html>
            ...
            <body style="background-image:url(images/table.jpg);background-repeat:no-repeat;" width="1920" height="1058">
                ...
                <br />
                <br />
                <table style="background-color:red; color:white; border-width:4px; border-style:solid; border-color:black;" align="center" width="500" height="300">
                    <tr>
                        <td align="center">
                            <br />
                            <p style="font-size:40px; color:grey; font-family:AR ADGothicJP Medium;">
                                <xsl:value-of select="wiki/Consoles/PS2/title" />
                            </p>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            ...
                            <p style="font-size:20px; color:white; font-family:Arial Narrow;">
                                <xsl:value-of select="wiki/Consoles/PS2/release" />
                            </p><br />
                    ...
                    <tr>
                        <td align="center">
                            <p style="font-size:20px; color:black;font-family:Arial Narrow;">
                                Price: </p>
                            <p style="font-size:20px; color:white; font-family:Arial Narrow;"> 
                                <xsl:value-of select="wiki/Consoles/PS2/price" />
                            </p><br />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <p style="font-size:20px; color:black;font-family:Arial Narrow;">
                                Media: </p>
                            <p style="font-size:20px; color:white;font-family:Arial Narrow;">
                                <xsl:value-of select="wiki/Consoles/PS2/media" />
                            </p><br />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <p style="font-size:20px; color:black;font-family:Arial Narrow;">
                                Best Selling Game: </p>
                            <p style="font-size:20px; color:white; font-family:Arial Narrow;">
                                <xsl:value-of select="wiki/Consoles/PS2/best" />
                            </p><br />
                        </td>
                    </tr>
                 <tr>
                        <td align="center">
                            <img width="150" height="70" src="images/ps2.fw.png" />
                        </td>
                    </tr>
                </table>
