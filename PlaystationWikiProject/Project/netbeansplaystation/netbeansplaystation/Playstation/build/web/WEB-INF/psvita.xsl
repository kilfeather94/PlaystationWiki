    ...
    <xsl:template match="/">
        <html>
            ...
            <body style="background-image:url(images/table.jpg);background-repeat:no-repeat;" width="1920" height="1058">
                ...
                <table style="background-color:red; width: 500; color:white; border-width:4px; border-style:solid; border-color:black;" align="center">
                    <tr>
                        <td align="center">
                            <br />
                            <p style="font-size:40px; color:grey; font-family:AR ADGothicJP Medium;">
                                <xsl:value-of select="wiki/Handhelds/VITA/title" />
                            </p>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            ...
                            <p style="font-size:20px; color:white;font-family:Arial Narrow;">
                                <xsl:value-of select="wiki/Handhelds/VITA/release" />
                            </p>
                            <br />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center">
                            <p style="font-size:20px; color:black; font-family:Arial Narrow;">
                                Price: </p>
                            <p style="font-size:20px; color:white;font-family:Arial Narrow;">
                                <xsl:value-of select="wiki/Handhelds/VITA/price" />
                            </p>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <p style="font-size:20px; color:black;font-family:Arial Narrow;">
                                Media: </p>
                            <p style="font-size:20px; color:white;font-family:Arial Narrow;">
                                <xsl:value-of select="wiki/Handhelds/VITA/media" />
                            </p>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <p style="font-size:20px; color:black; font-family:Arial Narrow;">
                                Best Selling Game: </p>
                            <p style="font-size:20px; color:white; font-family:Arial Narrow;"> 
                                <xsl:value-of select="wiki/Handhelds/VITA/best" />
                            </p>
                            <br />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center">
                            <img width="150" height="70" src="images/vita.fw.png" />
                        </td>
                    </tr>
